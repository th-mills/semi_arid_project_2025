function final_graphs(Graph_Options, Initial_Conditions, Field, Grass, rain, maps, tick_size, time_diff)
    ...
    if Graph_Options.biomass_movie
        ...
        v = VideoWriter(['Movies/' Graph_Options.biomass_movie_name], 'MPEG-4');
        open(v)
        for j=1:frames+1
    ...
    if Graph_Options.nitrogen_movie
        frames = Initial_Conditions.T/5;
        tstep = Initial_Conditions.T/frames;
        ...
        v = VideoWriter(['Movies/' Graph_Options.nitrogen_movie_name], 'MPEG-4');
        open(v)
        for j=1:frames+1
